...
def main(argv):
    ...
    # TODO: logic main should be extracted to method, main should use it like:
    # prcess_blabl_data(
    ...
    if  FLAGS.species == constants._SPECIES_HOMO_SAPIENS and \
    ...
    elif FLAGS.species == constants._SPECIES_MUS_MUSCULUS and \
    ...
    if data_type == constants._DATA_TYPE_SPATIAL:
        ...
        if FLAGS.miR_figures == constants._DRAW_BOTTOM_10 or len(miR_list) <= 10:
            ...
            mir_activity = utils.sort_activity_spatial(
                miR_activity_pvals, FLAGS.thresh, spots, results_path, FLAGS.dataset_name)
        ...
        utils.produce_spatial_maps(
            miR_list_figures, miR_activity_pvals, spatial_coors, results_path, FLAGS.dataset_name)
